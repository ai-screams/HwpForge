//! Integration-style tests for the crate-root entry points
//! (`inspect_hwp5`, `census_hwp5`, `hwp5_to_hwpx`, image/OLE asset
//! joining, …). Split out of `lib.rs` as a sibling module (task #93)
//! so the crate root stays readable; `use super::*` keeps every
//! existing assertion compiling unchanged.
