...
- **각주/미주 MD 브리지 에픽 완주** (2026-08-27~28, **`0.16.4`**): `[^N]`/`[^eN]` 양방향 왕복 (다문단·명명 라벨·표 셀·인라인 서식) + autoNum 번호 머리(**대칭 쌍 계약** — gotcha #34) + 편집 표면 fail-closed. 한컴 native fixture F1~F7 게이트 · 시각 게이트 3회 · 적대 리뷰 8라운드 수렴. 에픽 canonical = `.docs/planning/2026-08-27-footnote-endnote-md-bridge.md` (HITL 4건 백로그: ON_SECTION 정책·note format 승격·validate 값 범위·편집기 warning API).
...
- Cargo packages `11` · crates.io published `0.16.4` (각주/미주 MD 브리지, 2026-08-28) · MSRV `1.88` · Dev toolchain Rust `1.93`
